...
| [`eval`](eval/README.md) | Evaluation suite: engineering-capability property tests + layered benchmarks + cross-framework war room | `go test -race ./eval/` |
...
eval/                      evaluation suite: property tests + layered benchmarks + cross-framework war room
