...
func runGraph(host *demoapp.Host, agent *loop.Agent, retriever Retriever, history []*llm.Message, user *llm.Message, traceID string) (*loop.Result, time.Duration, error) {
